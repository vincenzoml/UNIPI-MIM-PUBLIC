...
class VoxLogicA:
    def __init__(self,voxlogica_bin):
        self.voxlogica_bin = voxlogica_bin
    def run(self,contents=None, filename=None, ptest=False, debug=False, taskGraph=False):        
            ...
            if taskGraph:
                ...
                if debug:
                    ...
                    try:        
                        ...
                        print("Error parsing voxlogica json output")
                        print(output)
                        exit(1)
